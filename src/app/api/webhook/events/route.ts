...
import { getMongoDBConnectionString, getOpenAIApiKey, getVectorSearchIndexName } from '@/lib/utils/env';
      ...
      return NextResponse.json(
        {
          ...
          invalidEvents,
          message: 'Each event must have a non-empty title and description'
        },
        { status: 400 }
      );
    }
